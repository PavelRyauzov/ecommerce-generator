Функция ПолучитьДанныеНоменклатуры() Экспорт
	...
	|ПО
	| Номенклатура.Ссылка = НоменклатураПрисоединенныеФайлы.ВладелецФайла
	|";
	...
	Пока Выборка.Следующий() Цикл  
		...
		Картинка.Вставить("base64", ?(ЗначениеЗаполнено(ФайлКартинки) И ФайлКартинки <> Null, ПолучитьКартинку(Выборка.ФайлКартинки), ""));
		Товар.Вставить("img", Картинка);
